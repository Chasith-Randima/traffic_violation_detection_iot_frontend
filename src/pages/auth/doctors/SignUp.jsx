    ...
    signup(user, "doctors")
      .then((data) => {
        if (data.status && data.status == "success") {
          ...
          Router.push(`/auth/doctors/LogIn`);
        } else {
          setAlert({
            ...alert,
            loading: false,
  ...
  return (
    <>
      ...
      <div className="flex flex-row md:flex-col items-center justify-center min-h-screen py-2 bg-gray-100">
        <div className="flex md:flex-col items-center justify-center md:w-full md:flex-2 md:px-20 text-center">
          <form className="bg-white rounded-2xl shadow-2xl md:flex md:w-2/3 md:max-w-4xl">
            ...
            <div className="md:w-2/5 bg-blue-500 text-white rounded-tr-2xl rounded-br-2xl pb-4  md:py-36 md:px-16 mb-2">
              <img
        ...
        <div className="max-w-lg mx-auto shadow px-6 py-7 rounded overflow-hidden">
          ...
          <form action="">
            <div className="space-y-4">
              ...
              <div>
                <label className="text-gray-600 mb-2 block">Doctor Id</label>
                <input
                  type="text"
                  value={doctorId}
                  onChange={handleChange("doctorId")}
          ...
          <p className="mt-4 text-gray-600 text-center">
            ...
            <Link href={`/auth/doctors/LogIn`} className="text-primary">
              LogIn Now
            </Link>
          </p>
        </div>
