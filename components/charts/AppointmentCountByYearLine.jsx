import { appointmentTimeByYear } from "actions/analytics";
...
const AppointmentCountByYearLine = ({ hospitalId }) => {
  ...
  useEffect(() => {
    ...
    console.log(hospitalId);
    appointmentTimeByYear(hospitalId)
      .then((data) => {
...
export default AppointmentCountByYearLine;
